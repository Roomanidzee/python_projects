...
class Starship:
    ...
    def set_starship_class(self, starship_class):
        self.__starship_class = starship_class

    def get_starship_class(self):
        return self.__starship_class
    ...
    def set_hyperdrive_rating(self, hyperdrive_rating):
        self.__hyperdrive_rating = hyperdrive_rating

    def get_hyperdrive_rating(self):
        return self.__hyperdrive_rating
